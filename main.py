...
# =============================================================================
# Este código simula um sistema de monitoramento industrial, onde sensores
# fornecem dados como posição e temperatura, e esses dados são registrados
# com data e hora.
#
# O objetivo é aplicar os conhecimentos fundamentais sobre módulos em Python:
#   - math: para cálculos matemáticos (circunferência da engrenagem).
#   - random: para gerar leituras simuladas de sensores.
#   - datetime: para registrar a data e hora de cada evento de monitoramento.
#
# Experimente alterar valores e testar diferentes comportamentos para
# consolidar o entendimento sobre modularização e reutilização de código.
# =============================================================================
